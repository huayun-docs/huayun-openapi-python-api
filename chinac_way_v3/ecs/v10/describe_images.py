...
class DescribeImages(RpcRequest):
    def __init__(self):
        super(DescribeImages, self).__init__('Ecs', '1.0', 'DescribeImages')
    ...
    def get_os_id(self):
        return self.get_query_params().get('OsId')

    def set_os_id(self, os_id):
        self.add_query_params('OsId', os_id)
